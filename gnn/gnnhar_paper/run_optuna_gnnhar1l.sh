...
# Optimizes: lr, weight_decay, n_hid, adj_threshold, dropout
# Expected: +5-10% R² improvement
# Duration: ~8 hours (100 trials)
...
# Change to project root directory (2 levels up from current script location)
...
echo "   python gnn/gnnhar_paper/train_multi_stock.py \\"
echo "       --model GNNHAR1L \\"
echo "       --activation gelu \\"
echo "       --n_seeds 20 \\"
echo "       --epochs 400 \\"
