@echo off
REM Test GELU vs ReLU activation functions
REM Small-scale test: 5 seeds, 100 epochs
REM Expected: GELU should show +2-5%% R² improvement
...
REM Test 1: ReLU (baseline)
echo ==========================================
echo   Test 1: ReLU Activation (Baseline)
echo ==========================================
python gnn\gnnhar_paper\train_multi_stock.py ^
    --model GNNHAR1L ^
    --n_seeds 5 ^
    --epochs 100 ^
    --n_hid 16 ^
